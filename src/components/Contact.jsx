...
const handleSubmit = (e) => {
  ...
  emailjs.send(
    import.meta.env.VITE_EMAILJS_SERVICE_ID, // depuis .env
    import.meta.env.VITE_EMAILJS_TEMPLATE_ID, // depuis .env
    {
      name: form.name,
      email: form.email,
      message: form.message,
    },
    import.meta.env.VITE_EMAILJS_PUBLIC_KEY // depuis .env
  )
  .then(() => {
    setLoading(false);
